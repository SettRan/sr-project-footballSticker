...
<main class="mb-5">
  ...
  <div class="container">
    <div class="row">
      <div class="col-12 mt-5 fs-3 fw-bolder border-bottom pb-2">
        Fill out the oder form.
      </div>
    <form class="mt-5" action="order_sumit.php" method="post">
    <div class="mb-3">
      <label for="exampleInputEmail1" class="fw-bolder form-label">Name</label>
      <input name="name" type="text" class="fw-bolder form-control" id="exampleInputEmail1" aria-describedby="emailHelp" required>
      <div id="emailHelp" class="form-text"></div>
    </div>
    <div class="mb-3">
      <label for="exampleInputEmail1" class="fw-bolder form-label">Eamil</label>
    ...
    <div class="mb-3">
      <label for="exampleInputEmail1" class="fw-bolder form-label">Address</label>
      <input name="address" type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" required>
      <div id="emailHelp" class="form-text"></div>
    </div>
    <div class="mb-3">
      <label for="exampleInputEmail1" class="fw-bolder form-label">Phone</label>
      <input name="ph" type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value=""  required>
      <!-- <div id="emailHelp" class="form-text">We'll never share your email with anyone else.</div> -->
    </div>
    <!-- <div class="mb-3 form-check">
      <input type="checkbox" class="text-dark form-check-input" id="exampleCheck1">
      <small><i>
      <label class="form-check-label" for="exampleCheck1">ကုန်ပစ္စည်းအသစ်များနှင့် ဆက်စပ်အကြောင်းအရာများအတွက် စာတိုလက်ခံမည်။</label>
      </i></small>
    </div> -->
    <a href="view_cat.php" class="btn btn-danger">&laquo; Back</a>
    <input type="submit" class="btn btn-primary text-white fw-bolder" value="Submit">
  </form>
    </div>
  </div>
</main>
