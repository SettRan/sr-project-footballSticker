        ...
        <div class="row">
          ...
          <p class="border-bottom fs-6 text-primary text-danger fw-bolder">SR <sub class="text-dark fw-bolder">Project </sub> </p>
            ...
            <p class="fw-bolder">Price - <span class="text-success fw-bolder"><?php echo $row['price'] ?></span>(kyats)</p><hr>
              ...
              ?>
            <form action="addtocart_edit.php">
            <p class="fw-bolder">Change the Qty</p>
                  <!-- print out session array where equal to id -->
            <input type="hidden" name="funi_id" value="<?php echo $id_num ?>">
            <input name="edit_num" class=" w-25" type="text" id="search" list="states" 
            placeholder="" value="<?php echo $_SESSION['cart'][$id_num] ?>">
                <!-- <datalist id="states">
                  <option value='၃ မျိုး'>
                </datalist> -->
            <input type="submit" value="OK" class="fw-bolder btn-primary">
            </form>
              
            <a href="view_cat.php" title="cart session တွင်စီမံနိုင်ပါသည်" href="" class="fw-bolder mt-3 btn btn-warning "><svg class="me-2" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-left-circle" viewBox="0 0 16 16">
