...
<body>
  ...
  <?php if($_GET['error']) : ?>
    <div class="alert alert-warning">User Name or Password doesn't match.</div>
  <? endif ?>
  ...
  <form class="shadow-lg p-3 mb-5 bg-white rounded container mt-5 border border-primary border-5" action="admin_home.php" method="post">
    ...
    <label for="exampleFormControlInput1" class="form-label fw-bolder text-success">password</label>
      <input name="admin_pw" type="password" class="form-control" id="exampleFormControlInput1" placeholder="Password" required><br>
      <a href="../index.php" class = "btn btn-info">&laquo;Back</a>
