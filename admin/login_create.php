...
<div class="container-fluid">
  <div class="row">
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 mt-3 mb-5">
      ...
      <form class="shadow-lg p-3 mb-5 bg-white rounded container mt-5 border border-dark border-5 mb-4" action="login_add.php" method="post">
        <div class="mb-3">
          ...
          <!-- <label for="exampleFormControlInput1" class="form-label fw-bolder text-dark">Extra password</label>
          <input name="comform_pw" type="password" class="form-control" id="exampleFormControlInput1" placeholder=""><br> -->

          <input type="submit" class="mt-3 btn btn-outline-primary fw-bolder" value="အသစ်တစ်ခုဖန်တီးမယ်">
    </form> 
...
<!-- identified the form -->
<script>
  function adminPw(passForm){
    if(passForm.admin_pw.value === " "){
      alert("စကားဝှက် ရိုက်ထည့်ပါ");
      passForm.admin_pw.focus();
      return false;
    }
    if(passForm.admin_pw.value != passForm.comform_pw.value){
      alert("ကိုက်ညီသော စကားကိုသာထည့်ပါ");
      passForm.admin_pw.focus();
      passForm.admin_pw.onselect();
      return false;
    }
    return true;
  }
