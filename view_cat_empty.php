...
<main>
  <div class="container shadow-lg p-3 mb-5 bg-white rounded mt-5">
    <div class="row">
      <div class="col-12">
      <button class="btn fs-3 btn-primary">
      There is nothing to show any of item yet.
      <p class="text-warning">If you pick something up to shopping card, will be appear here.</p>
      <a href="products.php?number=10000" class=" fs-3 btn btn-outline-light fw-bolder"><svg class="fw-bolder" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-cart-plus-fill" viewBox="0 0 16 16">
