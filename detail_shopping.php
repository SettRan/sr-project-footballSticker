      ...
      <div class="container">
        <div class="row">
          ...
          <p class="border-bottom fs-6 text-primary text-danger fw-bolder">SR <sub class="text-dark fw-bolder">Project </sub> </p>
            ...
            <a href="shopping.php?id=<?php echo $row['category_id'] ?>" title="cart session တွင်စီမံနိုင်ပါသည်" href="" class="fw-bolder mt-3 btn btn-outline-dark ">Continue <svg class="ms-3" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-right-circle" viewBox="0 0 16 16">
